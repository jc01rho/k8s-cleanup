...
RUN VERSION="1.3.1" ; wget https://github.com/containerd/nerdctl/releases/download/v${VERSION}/nerdctl-${VERSION}-linux-amd64.tar.gz ; tar xzvf nerdctl-$VERSION-linux-amd64.tar.gz -C  /usr/local/bin ; rm -f nerdctl-$VERSION-linux-amd64.tar.gz 
